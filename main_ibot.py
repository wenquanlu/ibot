...
def get_args_parser():
    ...
    # Misc
    parser.add_argument('--data_path', default='noisy_mini-imagenet-gauss100-denoised/train/', type=str,
...
def train_ibot(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        #utils.save_on_master(save_dict, os.path.join(args.output_dir, f'checkpoint_{epoch}.pth'))
